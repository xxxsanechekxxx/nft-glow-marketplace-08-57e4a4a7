              ...
              <div className="bid-card overflow-hidden rounded-lg border border-purple-500/20">
                <AccordionTrigger className="px-6 py-4 hover:no-underline">
                  <div className="flex w-full items-center gap-4">
                    ...
                    {nft?.image && (
                      <div className="h-16 w-16 md:h-20 md:w-20 flex-shrink-0 rounded-lg overflow-hidden border border-purple-600/20 relative">
                    ...
                    <div className="flex-grow space-y-1 text-left">
                      <h3 className="font-semibold text-lg md:text-xl line-clamp-1">{nft?.name || 'Unknown NFT'}</h3>
                      <div className="flex flex-wrap gap-2 items-center">
                        <Badge variant="outline" className="bg-amber-500/10 text-amber-200 border-amber-500/20 text-xs py-1">
                          <DollarSign className="w-3.5 h-3.5 mr-1" />
                          Top: {highestBid?.bid_amount} ETH
                        </Badge>
                        <Badge variant="outline" className="bg-blue-500/10 text-blue-200 border-blue-500/20 text-xs py-1">
                ...
                <AccordionContent className="px-6 pt-2 pb-5">
                      ...
                      {sortedBids.map((bid, index) => (
                        ...
                        >
                          <div className="flex items-start gap-3">
                            {/* Bidder Avatar */}
                            <div 
                              className={`bidder-avatar w-10 h-10 ${index === 0 ? 'bidder-avatar-highlighted' : ''}`}
                            >
                            ...
                            <div className="flex-grow">
                              ...
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                  <span className="text-sm font-medium">{bid.bidder_address}</span>
                                  {bid.bidder_verified && (
                                ...
                                {index === 0 && (
                                  <Badge className="bg-amber-500/20 text-amber-200 border-amber-500/30 sm:hidden text-[10px] h-5">
                                    Highest
                                  </Badge>
                                )}
                              </div>
              ...
              <div className={`text-center p-6 rounded-lg ${
                ...
                {actionType === "accept" ? (
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-sm text-green-300 mt-1">to {selectedBid.bidder_address}</span>
                  </div>
                ) : (
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-sm text-red-300 mt-1">from {selectedBid.bidder_address}</span>
                  </div>
                )}
              </div>
            </div>
