...
export const WalletTab = ({
  ...
  return (
    <Card className="border-primary/10 shadow-lg hover:shadow-primary/5 transition-all duration-300 backdrop-blur-sm bg-gradient-to-br from-[#1A1F2C]/95 to-[#1A1F2C]/80 overflow-hidden relative">
      ...
      <CardHeader className="space-y-2 border-b border-primary/10 pb-4 relative z-10 px-3 xs:px-4 sm:px-6">
      ...
      <CardContent className="p-3 xs:p-4 sm:p-6 relative z-10">
        <WalletBalance 
          userData={userData}
