  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <Button 
        ...
        variant="gradient"
        className="w-full flex items-center gap-3 p-6 h-auto group relative overflow-hidden"
      >
        ...
        <div className="flex flex-col items-start">
          <span className="text-lg font-semibold text-green-500">Deposit</span>
      ...
      >
        ...
        <div className="flex flex-col items-start">
          <span className="text-lg font-semibold text-destructive">Withdraw</span>
