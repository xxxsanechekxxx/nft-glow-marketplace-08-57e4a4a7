  ...
  useEffect(() => {
    if (userData) {
      setProfileData({
        ...
        usdt_balance: parseFloat(userData.usdt_balance),
        frozen_balance: parseFloat(userData.frozen_balance),
        frozen_usdt_balance: parseFloat(userData.frozen_usdt_balance),
      });
    }
  }, [userData]);
