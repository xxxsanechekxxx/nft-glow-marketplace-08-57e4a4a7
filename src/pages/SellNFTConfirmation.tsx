...
const SellNFTConfirmation = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-[#09081A] via-[#0E0D26] to-[#13123A] relative overflow-hidden">
      ...
      <div className="container max-w-4xl mx-auto px-6 relative z-10 py-12 pb-8">
